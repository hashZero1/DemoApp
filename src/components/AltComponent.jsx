  ...
  return (
    ...
    >
      <div className="max-w-[90rem] mx-auto">
        <Header />
        <div className="w-[30rem] mt-[10rem]">
          <h1 className="text-3xl lg:text-7xl text-gray-50 ">
          ...
          <button className="text-white text-xl rounded-full border py-4 px-16 hover:bg-slate-50/50 cursor-pointer transition-all">
            Grab the offer now
          </button>
        </div>
      </div>
