...
const AboutSection = () => {
  return (
    <div className="h-fit my-32 lg:my-42 flex flex-col items-center max-w-[90rem] justify-center mx-auto text-gray-800">
      <div className="flex flex-col items-center p-4 lg:p-2">
        <h1 className="font-semibold text-4xl lg:text-5xl">About Us</h1>

        <p className="text-xl lg:text-2xl mt-14 text-center w-full lg:w-[60rem] ">
